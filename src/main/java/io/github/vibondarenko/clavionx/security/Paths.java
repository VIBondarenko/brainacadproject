...
public final class Paths {
    ...
    public static final String REDIRECT_2FA_SETTINGS    = "redirect:/settings/2fa";
    public static final String REDIRECT_2FA_ENABLE      = "redirect:/settings/2fa/enable";
    public static final String REDIRECT_2FA_VERIFY      = "redirect:/settings/2fa/verify";
    public static final String REDIRECT_2FA_VERIFY2     = "redirect:/settings/2fa-verify";
