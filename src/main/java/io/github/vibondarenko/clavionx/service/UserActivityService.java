...
public class UserActivityService {
    ...
    public void logActivity(String actionType, String actionDescription) {
        try {
            ...
            if (auth != null && auth.isAuthenticated() && !"anonymousUser".equals(auth.getName())) {
                ...
                if (auth.getPrincipal() instanceof io.github.vibondarenko.clavionx.entity.User user) {
    ...
    public void logFailedActivity(String actionType, String actionDescription, String errorDetails) {
        try {
            ...
            if (auth != null && auth.getPrincipal() instanceof io.github.vibondarenko.clavionx.entity.User user) {
                activity.setUserId(user.getId());
            }
