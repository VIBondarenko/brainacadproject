...
private MockMvc mockMvc;
    ...
    void getUserActivities_WithUserRole_ShouldReturnForbidden() throws Exception {
        // When & Then
        mockMvc.perform(get("/api/v1/activities/user/100")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(roles = "USER")
    void getSuspiciousActivities_WithUserRole_ShouldReturnForbidden() throws Exception {
        // When & Then
        mockMvc.perform(get("/api/v1/activities/suspicious")
                        .param("ipAddress", "192.168.1.200")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(roles = "ADMIN")
    void cleanupOldActivities_WithAdminRole_ShouldReturnForbidden() throws Exception {
        // When & Then
        mockMvc.perform(post("/api/v1/activities/cleanup")
                        .param("daysToKeep", "90")
                        .with(csrf())
